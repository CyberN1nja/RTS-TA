...
public class Harvester : MonoBehaviour
{
    ...
    public void MoveTo(Transform target)
    {
        ...
        {
            unitMovement.MoveTo(target.position, false); // false = automatic via state machine
        }
    }
    ...
    private System.Collections.IEnumerator WaitInDepositingState()
    {
        ...
        ResourceManager.Instance.IncreaseResource(ResourceManager.ResourcesType.Credits, ConvertResourcesIntoCredits(tempCapacity));
    ...
    private int ConvertResourcesIntoCredits(float tempCapacity)
    {
